...
- Sử dụng Knowledge Base để cung cấp kiến thức chuyên ngành
- Tích hợp AI Agent để trả lời các câu hỏi về sản phẩm
