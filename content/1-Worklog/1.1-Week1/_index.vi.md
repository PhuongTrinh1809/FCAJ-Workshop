...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="col-task">- Tổng hợp kiến thức đã học trong Module 01. <br> - Kiểm tra kết quả các nhiệm vụ đã hoàn thành. <br> - Nhận được 100 USD AWS Credits.</td>
...
* Hoàn thành các nội dung học tập: Module 01-01: Điện Toán Đám Mây Là Gì?, Module 01-02: Điều Gì Tạo Nên Sự Khác Biệt Của AWS?, Module 01-03: Bắt Đầu Hành Trình Lên Mây Như Thế Nào?
* Hoàn thành 04 nhiệm vụ thực hành: Amazon Bedrock, Aurora and RDS, AWS Lambda, Amazon EC2
* Nhận được 100 USD AWS Credits để học tập và thực hành trên AWS.
