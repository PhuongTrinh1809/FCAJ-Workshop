...
* Learn the process of deploying web applications on AWS using Amazon EC2 and Amazon RDS.
* Study backup, restore, and Auto Scaling mechanisms.
* Practice configuring Load Balancer and system scaling methods.
...
* Understood the web application deployment process on AWS using Amazon EC2 and Amazon RDS.
* Successfully performed Backup and Restore operations.
* Understood how Launch Template and Auto Scaling Group work.
* Successfully configured Application Load Balancer and Target Group.
* Practiced system scaling models including Manual Scaling, Scheduled Scaling, Dynamic Scaling, and Predictive Scaling.
* Strengthened knowledge of scalability, high availability, and resource optimization on AWS.
