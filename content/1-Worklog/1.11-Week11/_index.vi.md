...
* Tích hợp phần hạ tầng AWS đã triển khai vào hệ thống chung của nhóm.
* Kiểm thử toàn bộ hệ thống.
* Điều chỉnh cấu hình để đảm bảo hệ thống hoạt động ổn định.
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="col-task">- Kiểm thử luồng truy cập của hệ thống. <br> - Phối hợp với các thành viên kiểm tra các chức năng sau khi tích hợp.</td>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện kiểm thử lại toàn bộ hệ thống. <br> - Đánh giá hiệu năng và khả năng bảo mật của kiến trúc triển khai.</td>
    ...
    <tr>
      ...
      <td class="col-task">- Tổng hợp kết quả triển khai. <br> - Chuẩn bị bàn giao phần hạ tầng để phục vụ giai đoạn hoàn thiện đồ án.</td>
