...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện tạo S3 Bucket trên AWS. <br> - Cấu hình: Bucket Name, AWS Region, Object Ownership (ACLs Disabled), Block Public Access theo khuyến nghị của AWS. <br> - Tìm hiểu các thiết lập bảo mật mặc định của Amazon S3.</td>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện tải mã nguồn website tĩnh lên S3 Bucket. <br> - Upload toàn bộ dữ liệu website vào Bucket. <br> - Kiểm tra cấu trúc thư mục và các đối tượng đã được lưu trữ thành công trên Amazon S3.</td>
    ...
    <tr>
      ...
      <td class="col-task">- Kích hoạt tính năng Static Website Hosting cho S3 Bucket. <br> - Cấu hình trang mặc định của website. <br> - Điều chỉnh Public Access Block và cấp quyền truy cập công khai cho các đối tượng phục vụ website. <br> - Kiểm tra khả năng truy cập website thông qua S3 Website Endpoint.</td>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện kiểm thử website sau khi triển khai. <br> - Xác nhận khả năng truy cập các trang và tài nguyên tĩnh. <br> - Tìm hiểu cơ chế lưu trữ và phân phối nội dung của Amazon S3.</td>
    ...
    <tr>
      ...
      <td class="col-task">- Tìm hiểu tính năng Bucket Versioning. <br> - Nghiên cứu cơ chế quản lý các phiên bản đối tượng trong S3. <br> - Thực hiện dọn dẹp tài nguyên sau khi hoàn thành Lab. <br> - Tổng hợp và hệ thống lại kiến thức đã học trong tuần.</td>
...
* Hiểu cơ chế Bucket Versioning và quản lý phiên bản dữ liệu trong Amazon S3.
* Củng cố kiến thức về lưu trữ, phân phối nội dung và tối ưu hiệu năng website trên nền tảng AWS.
